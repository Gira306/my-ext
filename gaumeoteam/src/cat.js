function execute(url, page) {
    ...
    if (response.ok) {
        ...
        let novelList = [];
        doc.select(".c-blog-listing c-page__content manga_content .c-blog__inner .c-blog__content .loop-content").forEach(e => {
            ...
            novelList.push({
                ...
                cover: cover,
                description: e.select(".list-chapter").first().text(),
                host: BASE_URL
            });
        })
